...
public class DBSchema {
    ...
    public static final String SQL_CREATE_LOCATION = "CREATE TABLE " + LOCATION_TABLE_NAME + "(" + COLUMN_ID + " INTEGER PRIMARY KEY UNIQUE NOT NULL," + COLUMN_NAME + " TEXT NOT NULL," + COLUMN_LOCATION_TITLE + " TEXT NOT NULL);";
    public static final String SQL_CREATE_IMAGE = "CREATE TABLE " + IMAGE_TABLE_NAME + "(" + COLUMN_ID + " INTEGER PRIMARY KEY UNIQUE NOT NULL," + COLUMN_NAME + " TEXT NOT NULL," + COLUMN_IMAGE_TITLE + " TEXT NOT NULL);";
    public static final String SQL_CREATE_AUDIO = "CREATE TABLE " + AUDIO_TABLE_NAME + "(" + COLUMN_ID + " INTEGER PRIMARY KEY UNIQUE NOT NULL," + COLUMN_NAME + " TEXT NOT NULL," + COLUMN_AUDIO_TITLE + " TEXT NOT NULL);";
    ...
    public static final String SQL_CREATE_DOCUMENT = "CREATE TABLE " + DOC_TABLE_NAME + "(" + COLUMN_ID + " INTEGER PRIMARY KEY UNIQUE NOT NULL," + COLUMN_NAME + " TEXT NOT NULL," + COLUMN_DOCUMENT_TITLE + " TEXT NOT NULL);";
